...
@section('content')
    ...
    <div class="container">
        ...
        <div class="container-content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form id="pemasukan-form" action="{{ url('pemasukan-update/' . $pemasukan->id) }}" method="post">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input name="sumber" type="text" class="form-control" id="sumber"
                                    placeholder="Masukkan Sumber Pemasukan" required value="{{ $pemasukan->sumber }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input name="jumlah" type="number" class="form-control" id="jumlah"
                                    placeholder="Masukkan Jumlah Pemasukan" required value="{{ $pemasukan->jumlah }}">
                            </div>
                        </div>
                        <a href="{{ url('viewpemasukan/' . $pemasukan->id) }}">
